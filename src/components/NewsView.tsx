...
const SOURCES_ZH: NewsSource[] = [
  { id: 'z1', name: '36氪', url: 'https://36kr.com/' },
  { id: 'z2', name: 'IT之家', url: 'https://www.ithome.com/' },
  { id: 'z3', name: '机器之心', url: 'https://www.jiqizhixin.com/' },
  { id: 'z4', name: 'Financial Times', url: 'https://www.ft.com/' },
];
  ...
  const fetchNews = async () => {
    ...
    try {
      ...
      const mockItemsZH: NewsItem[] = [
        ...
        {
          id: 'w2',
          title: '机器之心：远程办公趋势重塑商业房地产',
          content: '主要城市的办公室空置率继续攀升，迫使开发商重新思考城市空间并考虑住宅改造。',
          url: 'https://www.jiqizhixin.com/',
          source: '机器之心',
          date: updateTime,
          isRead: false
        ...
        {
          id: 'w3',
          title: '机器之心：尽管通胀，消费者支出仍保持韧性',
          content: '零售销售数据显示，即使基本商品价格仍然处于高位，家庭仍在继续在旅游和服务上支出。',
          url: 'https://www.jiqizhixin.com/',
          source: '机器之心',
          date: updateTime,
          isRead: false
            ...
            <button 
              onClick={() => {
                if (confirm(t.resetConfirm)) {
                  setSources(language === 'ZH' ? SOURCES_ZH : SOURCES_EN);
                  setActiveSourceId('all');
                  localStorage.removeItem('news_sources_v2');
                }
              }}
